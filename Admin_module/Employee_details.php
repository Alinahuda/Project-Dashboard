...
<body>
  ...
  <div class="wsu-logo">
    ...
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="Dashboard.php">EMPLOYEE DETAILS</a>
  ...
  <div class="container-fluid">
    <div class="col-md-8 ml-sm-auto col-lg-10  px-4">
      ...
      <input class="form-control" type="text" id="myInput"  placeholder="Search for Employee Name, Team, Email id...">
      <br>
...
//connect to db
 ...
 $query=mysqli_query($db,"select SNO, concat(firstname,' ',lastname) as EmployeeName,Major,Gmail,WsuEmail,Contact,Team,Date_format(Empdate,'%m/%d/%y') as Empdate,Date_format(GradDate,'%m/%d/%y') as GradDate from employee_details");
?>
<tbody id="myTable">
