...
['Project Name','Project Manager','Team Member', 'Start date','End date','Technology used','Project Description'],
 <?php 
 $query = "select ProjectName,ProjectManager,TeamMember,Date_format(Startdate,'%m/%d/%y') as Startdate,Date_format(Enddate,'%m/%d/%y') as Enddate,Techused,Description from projects_table order by Startdate desc";
 ...
 echo "['".$row['ProjectName']."','".$row['ProjectManager']."','".$row['TeamMember']."','".$row['Startdate']."','".$row['Enddate']."','".$row['Techused']."','".$row['Description']."'],";
 }
 ?>
 ...
 var table = new google.visualization.Table(document.getElementById("mychart2"));
